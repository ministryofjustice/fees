...
ActiveRecord::Schema.define(version: 20150303160839) do
  ...
  create_table "general_applications", force: :cascade do |t|
    t.string   "title"
    t.integer  "fee"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "statutory_instruments", force: :cascade do |t|
    t.string   "title"
    t.text     "description"
